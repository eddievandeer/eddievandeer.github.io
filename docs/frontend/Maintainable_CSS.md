...
每周组会的分享轮到了《如何编写可维护的CSS》这个主题，自认为 CSS 和 JS 能够达到 64 开的我自然不会错过这个表现自己的机会。虽然我可能更擅长利用 CSS 设计和实现各种花里胡哨的样式，但好歹也是 CSS 的话题，CSS 的可维护性也是略知一二，顺便再加上一些现学现卖的内容，便组成了这一篇文章
