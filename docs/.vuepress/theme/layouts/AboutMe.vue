            ...
            <div class="about-sidebar">
                <div class="site-info">
                    <div class="site-author">
                        <div class="site-author__avatar">
                            <img src="/assets/img/avatars.jpg" alt="">
                        </div>
                        <div class="site-author__name">Vivek</div>
                        <sup class="author-info__description">To be the best, you gotta beat the
                            best.</sup>
                    </div>
                    <div class="site-links">
                        <a class="site-links-item" href="https://github.com/eddievandeer" style="color: #24292E;">
            ...
            <div class="about-me">
                <div class="about-content">
                    <div class="about-title">
                        <svg id="icon-cloud-line" viewBox="0 0 1024 1024">
                            <path
                                d="M725.333333 896H298.666667A256 256 0 0 1 213.674667 398.464a298.666667 298.666667 0 1 1 596.650666 0A256 256 0 0 1 725.333333 896z m0-512a213.333333 213.333333 0 1 0-426.410666 10.368l2.986666 63.488-59.904 21.077333A170.752 170.752 0 0 0 298.666667 810.666667h426.666666a170.666667 170.666667 0 1 0-161.962666-224.64l-80.981334-27.008A256.128 256.128 0 0 1 725.333333 384z">
                            </path>
                        </svg>
                        <h1> {{$page.title}} </h1>
                    </div>
